...
* [Power BI Tenant settings](https://app.powerbi.com/admin-portal/tenantSettings)
* [Power Platform admin center](https://admin.powerplatform.microsoft.com) [🏷️](https://aka.ms/ppac)
...
* [Yammer lookbook](https://teamworktools.azurewebsites.net/yammer/Yammer%20Lookbook.pdf)
* [My Applications (My Apps)](https://myapplications.microsoft.com/)
* [My Access (Access Packages)](https://myaccess.microsoft.com/)
...
* [Microsoft 365 Network Insights](https://portal.office.com/adminportal/home#/networkperformance)
...
* [Sign-up for Office 365 E5  25 licenses  30-day free trial](https://signup.microsoft.com/get-started/signup?products=101bde18-5ffb-4d79-a47b-f5b2c62525b3&culture=en-us&country=US&ali=1&bac=1&signedinuser=BWNSUP%40mn.nl)
* []()
* []()
...
* [Microsoft Online account manager](https://portal.microsoftonline.com/IWDefault.aspx)
* [Microsoft change password](https://account.activedirectory.windowsazure.com/ChangePassword.aspx)
* [Microsoft password reset page (lost password)](https://passwordreset.activedirectory.windowsazure.cn/)
* [MN update password page (adfs)](https://sts.mn-services.nl/adfs/portal/updatepassword/)
...
* [Microsoft Online Error Code Lookup](https://login.microsoftonline.com/error)F
* [Visual Studio Subscriptions](https://my.visualstudio.co)
* [Visual Studio Subscriptions Management](https://manage.visualstudio.com)
* [Microsoft Clarity / MS Google analytics (HeatMaps & Sessions Recordings)](https://clarity.microsoft.com/)
...
* [Microsoft Teams & Microsoft 365 Developer platform](https://adoption.microsoft.com/virtual-hub/microsoft-teams-365-developer-platform/)
* [Yammer administration documentation](https://docs.microsoft.com/en-us/yammer/)
* [Microsoft Power Platform documentation](https://docs.microsoft.com/en-us/power-platform/)
* [Docs - Browse code samples](https://docs.microsoft.com/en-us/samples/browse/)
* [Microsoft 365 compliance documentation](https://docs.microsoft.com/en-us/microsoft-365/compliance/?view=o365-worldwide)
* [SharePoint documentation](https://docs.microsoft.com/en-us/sharepoint/)
* [OneDrive documentation](https://docs.microsoft.com/en-us/onedrive/)
* [Microsoft Compliance](https://docs.microsoft.com/en-us/compliance/?view=o365-worldwide)
* [Microsoft Defender for Office 365 documentation](https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/?view=o365-worldwide)
* [Microsoft 365 documentation](https://docs.microsoft.com/en-us/microsoft-365/?view=o365-worldwide)
* [Microsoft Graph documentation](https://docs.microsoft.com/en-us/graph/)
* [PowerShell Documentation](https://docs.microsoft.com/en-us/powershell/?view=powershell-7.1)
* [Visual Studio Code Docs](https://code.visualstudio.com/docs)
* [Microsoft 365 and Office 365 service descriptions](https://docs.microsoft.com/en-us/office365/servicedescriptions/office-365-service-descriptions-technet-library)
* [Microsoft 365 suite features](https://docs.microsoft.com/en-us/office365/servicedescriptions/office-365-platform-service-description/office-365-suite-features)
...
* [Auditing solutions in Microsoft 365](https://docs.microsoft.com/en-us/microsoft-365/compliance/auditing-solutions-overview?view=o365-worldwide)
* [Microsoft Power Platform guidance documentation](https://docs.microsoft.com/en-us/power-platform/guidance/)
* [Yammer administration documentation](https://docs.microsoft.com/en-us/yammer/)
* [Microsoft 365-oplossingen- en -architectuurcentrum](https://docs.microsoft.com/nl-nl/microsoft-365/solutions/?view=o365-worldwide)
* [Power platform Connectors documentation](https://docs.microsoft.com/en-us/connectors/)
* [Where your Microsoft 365 customer data is stored](https://docs.microsoft.com/en-us/microsoft-365/enterprise/o365-data-locations?geo=Europe&view=o365-worldwide#Europe)
...
* [Use SharePoint and Power Automate to build workflows](https://docs.microsoft.com/en-us/power-automate/sharepoint-overview)
* [Guidance: Migrate from classic workflows to Power Automate flows in SharePoint](https://docs.microsoft.com/en-us/sharepoint/dev/business-apps/power-automate/guidance/migrate-from-classic-workflows-to-power-automate-flows)
...
* [PowerApps Admin in a day course](https://github.com/microsoft/powerapps-tools/tree/master/Administration/AdminInADay)
...
* [Microsoft Learn Blog](https://techcommunity.microsoft.com/t5/microsoft-learn-blog/bg-p/MicrosoftLearnBlog/label-name/Power%20Platform)
* [Microsoft Learning campus course catalog](https://mslearningcampus.com/Organization/CourseCatalog/1553/#%7B%22pageIndex%22%3A0%2C%22pageSize%22%3A20%2C%22filter%22%3A%22%22%2C%22matchType%22%3A%220%22%2C%22clubIds%22%3A%5B%5D%2C%22tagInputIds%22%3A%5B%5D%2C%22tagsJson%22%3Anull%2C%22bookmarks%22%3Anull%7D)
...
* [Power Platform Training Materials (blog)](https://powerusers.microsoft.com/t5/Power-Apps-Community-Blog/Power-Platform-Training-Materials/ba-p/342088)
* [Microsoft Learn - browse all](https://docs.microsoft.com/en-us/learn/browse/?products=m365&resource_type=learning%20path&roles=developer)
* [Connect web services to Microsoft Teams with webhooks and Office 365 Connectors](https://docs.microsoft.com/en-us/learn/modules/msteams-webhooks-connectors/)
...
* [Microsoft Endpoint Manager Admin Console](https://devicemanagement.portal.azure.com)
...
* [Microsoft Defender for Endpoints (MDE)](https://securitycenter.windows.com)
* [Microsoft Defender for Identity (MDI)](https://portal.atp.azure.com)
* [Microsoft Defender ATP Testground](https://demo.wd.microsoft.com/)
* [Microsoft Secure Score](https://securescore.microsoft.com)
...
* [Report an unsafe site (login)](https://www.microsoft.com/en-us/wdsi/support/report-unsafe-site)
* [Report an unsafe site (guest)](https://www.microsoft.com/en-us/wdsi/support/report-unsafe-site-guest)
...
* [Microsoft 365 Service health (Admin portal)](https://portal.office.com/adminportal/home#/servicehealth)
...
* [Infringement Report](https://msrc.microsoft.com/report/infringement)
...
* [Microsoft Dynamics Trials](https://trials.dynamics.com/)
* [Microsoft Home Use Program](https://www.microsoft.com/home-use-program)
* [Microsoft MVP](https://mvp.microsoft.com)
* [Microsoft Reseller Profile Registration Portal](https://reselleruat.microsoftcrmportals.com/)
* [Microsoft Security Response Center](https://msrc-blog.microsoft.com/)
* [Microsoft Startups](https://portal.startups.microsoft.com)
* ["Microsoft 365 Lighthouse](https://lighthouse.microsoft.com/)
* [Office 365 Anti-Spam IP Delist Portal](https://sender.office.com)
* [Outlook OAuth Sandbox](https://oauthplay.azurewebsites.net/)
* [Office UI Fabric Icons](https://uifabricicons.azurewebsites.net/)
* [PowerApps Unified Interface Transition Portal](https://runone.powerappsportals.com)
* [PowerBI Embedded Playground](https://microsoft.github.io/PowerBI-JavaScript/demo/v2-demo/index.html)
* [Azure Cosmos DB Query Playground](https://www.documentdb.com/sql/demo)
...
* [Windows Insider Lab for Enterprise](https://olympia.windows.com/)
* [Skype Preview / Microsoft Teams Preview](https://www.skypepreview.com)
* [Outlook.com Smart Network Data Service](https://sendersupport.olc.protection.outlook.com/snds/index.aspx)
* [Azure Pass - Activate Azure subscription using Azure Pass Codes](https://www.microsoftazurepass.com/)
* [Microsoft events](https://events.microsoft.com/en-us/Allevents/?language=English&timeperiod=next30Days&isSharedInLocalViewMode=false )
...
* [Debble insiders blog](https://debble.com/insiders-blog/)
* [Debble storingen](https://debble.com/actuele-storingen)
* [Debble release notes](https://debble.com/releasenotes)
* [Wortell service portal](https://wortell.service-now.com/csm/?id=csm_index)

## Misc

* [Pearson vue Microsoft](https://home.pearsonvue.com/microsoft)
* [Joanne C Klein](https://joannecklein.com/)
* [SharePoint Diary](https://www.sharepointdiary.com/)
* [Jump to 365](https://www.jumpto365.com)
* [AdminDroid Blog](https://blog.admindroid.com/)
* [Power automate blog](https://flow.microsoft.com/nl-nl/blog/)
